        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4">
                <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Tambah Experience</h1>
                        ...
                        <form action="store.php" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="masih_bekerja" value="1" id="masih_bekerja">
                                    <label class="form-check-label" for="masih_bekerja">Masih bekerja di sini</label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tanggung Jawab</label>
                                <textarea class="form-control" name="tanggung_jawab" rows="5"></textarea>
                            </div>
